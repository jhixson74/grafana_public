...
System.register(['lodash', './threshold_mapper', 'app/core/components/query_part/query_part', './alert_def', 'app/core/config', 'moment', 'app/core/app_events'], function(exports_1) {
    var lodash_1, threshold_mapper_1, query_part_1, alert_def_1, config_1, moment_1, app_events_1;
    var AlertTabCtrl;
    /** @ngInject */
    function alertTab() {
        'use strict';
                ...
                AlertTabCtrl.prototype.getAlertHistory = function () {
                    ...
                    this.backendSrv.get("/api/annotations?dashboardId=" + this.panelCtrl.dashboard.id + "&panelId=" + this.panel.id + "&limit=50").then(function (res) {
                        _this.alertHistory = lodash_1.default.map(res, function (ah) {
                            ...
                            ah.metrics = alert_def_1.default.joinEvalMatches(ah.data, ', ');
                            return ah;
                        });
                    });
                };
