    ...
    return {
        ...
        execute: function() {
            DashboardCtrl = (function () {
                /** @ngInject */
                function DashboardCtrl($scope, $rootScope, dashboardKeybindings, timeSrv, variableSrv, dashboardSrv, unsavedChangesSrv, dynamicDashboardSrv, dashboardViewStateSrv, contextSrv, alertSrv, $timeout) {
                    this.$scope = $scope;
