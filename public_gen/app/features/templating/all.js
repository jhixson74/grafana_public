System.register(['./templateSrv', './editor_ctrl', './variable_srv', './interval_variable', './query_variable', './datasource_variable', './custom_variable', './constant_variable', './adhoc_variable'], function(exports_1) {
