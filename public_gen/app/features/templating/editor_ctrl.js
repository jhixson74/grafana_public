...
System.register(['lodash', 'app/core/core_module', './variable'], function(exports_1) {
    var lodash_1, core_module_1, variable_1;
    var VariableEditorCtrl;
    return {
        setters:[
            function (lodash_1_1) {
                lodash_1 = lodash_1_1;
            ...
            VariableEditorCtrl = (function () {
                ...
                function VariableEditorCtrl($scope, datasourceSrv, variableSrv, templateSrv) {
                    ...
                    $scope.duplicate = function (variable) {
                        var clone = lodash_1.default.cloneDeep(variable.getModel());
