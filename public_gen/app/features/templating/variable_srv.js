...
System.register(['angular', 'lodash', 'app/core/core_module', './variable'], function(exports_1) {
    var angular_1, lodash_1, core_module_1, variable_1;
    var VariableSrv;
    return {
        setters:[
        ...
        execute: function() {
            VariableSrv = (function () {
                ...
                VariableSrv.prototype.syncToDashboardModel = function () {
                    this.dashboard.templating.list = this.variables.map(function (variable) {
